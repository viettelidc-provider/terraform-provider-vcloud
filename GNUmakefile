...
build: fmtcheck
	go install -ldflags="-X 'github.com/terraform-viettelidc/terraform-provider-vcloud/v3/vcloud.BuildVersion=$(GIT_DESCRIBE)'"

# builds the plugin with race detector enabled and injecting output of `git describe` to BuildVersion variable
buildrace: fmtcheck
	go install --race -ldflags="-X 'github.com/terraform-viettelidc/terraform-provider-vcloud/v3/vcloud.BuildVersion=$(GIT_DESCRIBE)'"

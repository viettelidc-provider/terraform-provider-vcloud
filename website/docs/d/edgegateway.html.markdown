...
All attributes defined in [edge gateway resource](/providers/viettelidc-provider/vcloud/latest/docs/resources/edgegateway#attribute-reference) are supported.
